...
class ReportUserDialog extends StatefulWidget {
  ReportUserDialog({Key? key, required this.onConfirm}) : super(key: key);
  Function(String, String) onConfirm;

  @override
  BaseState<ReportUserDialog> createState() => _ReportUserDialog();
}

class _ReportUserDialog extends BaseState<ReportUserDialog> {
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
                itemCount: Constants.reportUserLists.length,
                shrinkWrap: true,
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  AppText(
                                    text: Constants.reportUserLists[index],
                                    color: ColorConstants.white,
                                    fontSize: 14,
                                  ),
                                ],
