...
class MentionTextEditingController extends TextEditingController {
  ...
  MentionTextEditingController({
    ...
    this.escapingMentionCharacter = MentionConstants.escapingMentionCharacter,
  ...
  String? _getMentionCandidate(String value) {
    const mentionCharacter = MentionConstants.mentionCharacter;
  ...
  TextSpan buildTextSpan({
    ...
    const urlReg = r"^((((H|h)(T|t)|(F|f))(T|t)(P|p)((S|s)?))\://)?(www.|[a-zA-Z0-9].)[a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,6}(\:[0-9]{1,5})*(/($|[a-zA-Z0-9\.\,\;\?\'\\\+&amp;%\$#\=~_\-]+))*$";
    return TextSpan(
      style: style,
      children: res.map((e) {
